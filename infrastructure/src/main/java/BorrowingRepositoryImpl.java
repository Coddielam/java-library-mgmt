...
public class BorrowingRepositoryImpl implements BorrowingRepository {
    ...
    private static Borrowing mapResultSetToBorrowing(ResultSet rs) throws SQLException {
        ...
        borrowing.setBorrowedDate(
                parsePostgresTimestamp(rs.getString("borrowed_date")));
        borrowing.setDueDate(
                parsePostgresTimestamp(rs.getString("due_date")));
        borrowing.setDueDate(
                parsePostgresTimestamp(rs.getString("due_date")));
        if (borrowing.getReturnDate() != null) {
            borrowing.setDueDate(
                    parsePostgresTimestamp(rs.getString("return_date")));
        }
        borrowing.setBookId(
    ...
    private static LocalDateTime parsePostgresTimestamp(String timestamp) {
